                    ...
                    <div>
                        <el-row :gutter="10">
                            <el-col :xs="24" :sm="24" :md="24" :lg="8" :xl="3">
                                <el-select
                                    v-model="data.search.application" class="head-btn" placeholder="类型"
                                    clearable
                                >
                                    <el-option label="住宅" :value="0" />
                                    <el-option label="车位" :value="1" />
                                    <el-option label="商业" :value="2" />
                                    <el-option label="商服" :value="3" />
                                </el-select>
                            </el-col>
                            <el-col :xs="24" :sm="24" :md="24" :lg="8" :xl="3">
                                <el-select v-model="data.search.property" class="head-btn" placeholder="产权" clearable>
                                    <el-option label="无" :value="0" />
                                    <el-option label="有" :value="1" />
                                </el-select>
                            </el-col>
                            <el-col :xs="24" :sm="24" :md="24" :lg="8" :xl="3">
                                <el-select v-model="data.search.binding" class="head-btn" placeholder="绑定" clearable>
                                    <el-option label="未绑" :value="0" />
                                    <el-option label="已绑" :value="1" />
                                </el-select>
                            </el-col>
                            <el-col :xs="24" :sm="24" :md="24" :lg="8" :xl="3">
                                <el-select v-model="data.search.type" class="head-btn" placeholder="类别" clearable>
                                    <el-option label="按姓名" :value="0" />
                                    <el-option label="按房号" :value="1" />
                                    <el-option label="按电话" :value="2" />
                                    <el-option label="按ID" :value="3" />
                                </el-select>
                            </el-col>
