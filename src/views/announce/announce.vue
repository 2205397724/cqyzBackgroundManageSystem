    ...
    <div class="articletplarticle">
        <page-main style="overflow: hidden;">
            ...
            <el-table
                ...
                class="tab_1"
            >
                <el-table-column label="公示主题" prop="title"></el-table-column>
                ...
                <el-table-column fixed="right" label="操作" width="220">
                    <template #default="scope">
                        ...
                        <el-link :underline="false" type="primary">
                            <router-link class="el-button details" :to="{name: 'announceDetail',query:{ id : scope.row.id }}">详情</router-link>
                        </el-link>
                        <el-popconfirm
...
const getTabListFunc = () => {
    ...
    if (JSON.parse(localStorage.getItem(localStorage.getItem('uid') + '_user_group')) && localStorage.getItem('utype') != 'pt') {
        params.groupcc = JSON.parse(localStorage.getItem(localStorage.getItem('uid') + '_user_group')).region_cc
    }
