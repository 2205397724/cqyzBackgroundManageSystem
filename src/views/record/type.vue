<template>
  <div>
    ...
    <!-- 添加子类别 -->
    <el-dialog title="添加子备案" v-model="switch_add_recordKind_children">
      <el-form :model="from_record_children.item" label-position="left">
        <el-row :gutter="10">
          <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
            <el-form-item label="子备案类型名称" prop="name" label-width="110px">
              <el-input v-model="from_record_children.item.name"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="10">
          <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
            <el-form-item label="排序" prop="sort" label-width="110px">
              <el-input v-model="from_record_children.item.sort" placeholder="可不填"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
