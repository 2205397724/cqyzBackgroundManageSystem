<template>
    <div style="height: 100%;">
        ...
        >
            <span style="line-height: 1rem;white-space: nowrap;overflow: hidden;">{{ props.str?props.str:'请点击选择单元ID' }}</span>
        ...
        <el-dialog
            ...
            width="70%"
        >
            <div style="font-size: 14px;color: #aaaaaa;margin-bottom: 8px;">*点击单元所在行选择该单元</div>
            <el-table
