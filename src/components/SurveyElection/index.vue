    ...
    <div>
        <el-scrollbar height="400px">
            ...
            >
                ...
                <el-table-column prop="title" label="候选人" />
                ...
                <el-table-column prop="type" label="候选人排序">
                    <template #default="scope">
            ...
            <div>
                <div class="details-box">
                    <el-form :model="topic_examine.item" label-position="left">
                        <el-row>
                            <el-col>
                                <el-form-item label="候选人" label-width="80px">
                                    <el-input
                        ...
                        <el-row>
                            <el-col>
                                <el-form-item label="基本信息" label-width="80px">
                                    <editor v-model="topic_examine.item.extra" class="" />
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row>
                            <el-col>
                                <el-form-item label="排列顺序" label-width="80px">
                                    <el-input v-model="topic_examine.item.sort" />
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row>
                        ...
                        <el-row v-if="topic_examine.item.score_calc != 0" :gutter="10">
                            <el-col>
                                <el-form-item label="选项分值" label-width="80px">
...
const addServeyTopic = () => {
    ...
    // 清除问卷的信息
    topic_examine.item = { 'sid': props.id, 'sort': 5, 'score': 0 }
    opts.length = 0
}
// 修改问卷题目
