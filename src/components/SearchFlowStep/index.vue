<template>
    <div style="height: 100%;">
        ...
        >
            ...
            <div style="font-size: 14px;color: #aaaaaa;margin-bottom: 8px;padding-top: 8px;">*点击流程后面的步骤</div>
            <el-table
        ...
        <el-dialog
            ...
            width="70%"
        >
            <div style="font-size: 14px;color: #aaaaaa;margin-bottom: 8px;padding-top: 8px;">*点击步骤所在行选择步骤</div>
            <el-table
