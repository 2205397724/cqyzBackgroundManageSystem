<template>
    <div style="height: 100%;display: inline-block;width: 100%;">
        ...
        >
            <span style="line-height: 1rem;white-space: nowrap;overflow: hidden;">{{ props.str?props.str:'请点击选择产权' }}</span>
        ...
        >
            ...
            <div style="font-size: 14px;color: #aaa;margin-bottom: 8px;padding-top: 8px;">*点击产权所在行选择该产权</div>
            <el-table
