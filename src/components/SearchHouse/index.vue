<template>
    <div style="height: 100%;display: inline-block;width: 100%;">
        ...
        >
            <span style="line-height: 1rem;white-space: nowrap;overflow: hidden;">{{ props.str?props.str:'请点击选择房屋ID' }}</span>
        ...
        >
            <el-row :gutter="10">
                ...
                <el-col v-if="data_search.obj.houseable_type" :xs="12" :sm="8" :md="6" :lg="4" :xl="3" class="el-cascader-box-my" style="box-sizing: border-box;padding-bottom: 10px;font-size: 12px;">
