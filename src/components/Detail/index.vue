<template>
    <div class="container">
        ...
        <div>
            ...
            <el-button size="small" type="primary" @click="exchangeStatus('2')">待审</el-button>
            <el-button size="small" type="info" @click="exchangeStatus('3')">未开始</el-button>
            <el-button size="small" type="success" @click="exchangeStatus('4')">进行中</el-button>
            <el-button size="small" type="warning" @click="exchangeStatus('5')">暂停</el-button>
            <el-button size="small" type="warning" @click="exchangeStatus('6')">终止</el-button>
            <el-button size="small" type="danger" @click="exchangeStatus('7')">已结束</el-button>
        </div>
        <el-tabs v-model="activeName" @tab-click="changePane">
            ...
            <el-tab-pane label="设置参与范围" name="2">
                <el-button type="primary" class="m-tb-10" style="position: relative;" @click="detail_set_area">设置</el-button>
                    ...
                    <el-col :sm="6" :md="6" :lg="6">
                        <div class="set_range_box">
                            ...
                            <el-scrollbar height="300px">
                                <div class="region_box">
                                    <div v-for="item in data_range.arr" :key="item.id">
                                        <div v-if="item.type==4" class="region_box_item" @click="clickZone(item)">
                                            {{ item.tgt_name }}
                                            <el-popconfirm
                                                title="确定要删除当前项么?" cancel-button-type="info"
                                                @confirm="deleteRange(item)"
